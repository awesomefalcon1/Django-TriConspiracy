...
class TavusClient:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        Args:
            api_key (str, optional): Tavus API key. If not provided, will use the hardcoded key
        """
        # Use provided API key, settings key, or hardcoded key as fallback
        self.api_key = (
            api_key or 
            getattr(settings, 'TAVUS_API_KEY', None) or 
            '34797912700f4707ac301be9bcde0065'
        )
